...
BEGIN {
  @symbols_to_clean_up =
    qw( POE_USES_TIME_HIRES SUBSTRATE_NAME_EVENT SUBSTRATE_NAME_GTK
        ...
        SS_PROCESSES SS_ID SS_EXTRA_REFS SS_POST_COUNT SH_HANDLE
        SH_REFCOUNT SH_VECCOUNT KR_SESSIONS KR_VECTORS KR_HANDLES
        KR_STATES KR_SIGNALS KR_ALIASES KR_ACTIVE_SESSION KR_PROCESSES
        KR_EVENTS KR_ID KR_SESSION_IDS KR_ID_INDEX KR_WATCHER_TIMER
        KR_WATCHER_IDLE KR_EXTRA_REFS KR_EVENT_IDS KR_SIZE HND_HANDLE
